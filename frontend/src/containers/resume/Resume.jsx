import { ResumeFeature, Navbar } from "../../components";
                  ...
                  <div className="pf__Resume_container-features-wrapper-Text">
                    <div className="pf__Resume_container-features-wrapper-Text-div">
                      ...
                      <p>
                        ...
                        controllers) Input/Output electronics and preparing
                        setups for CI/CD autonomous and manual testing.
                      </p>
                    </div>
                    <div className="pf__Resume_container-features-wrapper-Text-div">
                      &#8226;
                    ...
                    <div className="pf__Resume_container-features-wrapper-Text-div">
                      &#8226;
                      <p>
                        Acquiring a thorough understanding of the application
                        for PLC as well as scripting for the testing of
                        electronics to ensure compliance with electromagnetic
                  ...
                  <div>
                    <div className="pf__Resume_container-features-wrapper-Text-div">
                      ...
                      <p>
                        ...
                        temperature chambers, energy measurement data from
                        various equipment, as well as inputs from sensors and
                        outputs from actuators. Ensuring the proper operation of
                        these signals is crucial for the overall effectiveness
                    ...
                    <div className="pf__Resume_container-features-wrapper-Text-div">
                      &#8226;
                      <p>
                        Programming of PLCs, reading electrical panel diagrams
                        as well as creating them and using software like EPLAN
                        and AUTOCAD to plan and document electrical automation
                        projects.
                      </p>
                    </div>
                  </div>
